...
GROUP BY driver_name, LOWER(u.id), (t.whendroppedoff AT TIME ZONE 'UTC' AT TIME ZONE 'MST')::date,  TO_CHAR((t.whendroppedoff AT TIME ZONE 'UTC' AT TIME ZONE 'MST'), 'Month DD, YYYY')
